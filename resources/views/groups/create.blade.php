<x-app-layout>
    ...
    <x-slot name="subtitle">Add a new group to categorize your clients.</x-slot>
            ...
            <form action="{{ route('groups.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" 
                              class="w-full rounded-lg border-slate-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm sm:text-sm">{{ old('description') }}</textarea>
